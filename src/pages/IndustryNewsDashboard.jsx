...
const API_URL = `${backendUrl}/api/allIndustrySectorAnalysis`;
        ...
        <div className="space-y-4 mb-8">
          ...
          <div className="space-y-4">
            {Object.entries(metrics).map(([label, value]) => (
              <div
                key={label}
                className="p-4 bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-300"
              >
                <div className="flex items-start gap-3">
                  {/* Icon per metric */}
                  <div className="mt-1">
                    <div className="w-10 h-10 bg-blue-100 text-blue-600 rounded-xl flex items-center justify-center text-xl font-bold">
                      {label.startsWith("Employment")
                        ? "👥"
                        : label.startsWith("Revenue")
                        ? "💰"
                        : label.startsWith("Investment")
                        ? "📈"
                        : "📊"}
                    </div>
                  </div>
  ...
  <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 flex flex-col items-center justify-center">
    ...
    <div className="text-center">
      ...
      <p className="text-gray-600 font-medium">
        Fetching the latest industry insights...
      </p>
    </div>
  </div>
);
        ...
        <div className="pt-32 max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed font-medium mb-6">
              Comprehensive real-time analysis of top-performing industries
              driving real estate demand across key markets
            </p>
            ...
            {dashboardData?.as_of && (
              <div className="inline-flex items-center gap-3 px-6 py-3 bg-white rounded-full shadow-lg border border-gray-100">
                ...
                <span className="text-gray-700 font-semibold">
                  Live Data • Updated {dashboardData.as_of}
                </span>
              </div>
            )}
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8 mb-20">
            {dashboardData.sectors.map((item, idx) => (
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10">
                {Object.entries(dashboardData.economic_context)
                  ...
                  .map(([label, value], idx) => (
                    <div
                      key={idx}
                      className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl p-6 border border-gray-100 hover:border-blue-200 hover:shadow-lg transition-all duration-300 group"
                    >
